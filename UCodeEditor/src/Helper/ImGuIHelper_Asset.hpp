...
public:
	...
	static bool AsssetField(const char* FieldName, UC::RawEntityDataAssetPtr& Value);
	static bool AsssetField(const char* FieldName, UC::RawEntityDataPtr& Value);
	static bool AssetField(UC::RawEntityDataPtr& Value);
