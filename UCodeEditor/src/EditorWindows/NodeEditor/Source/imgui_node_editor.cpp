...
{
    return ImGui::GetKeyIndex(ImGuiKey_F);
   // return KeyTester_ImGuiKey_F::Get<ImGuiKey_F>(nullptr);
}

static inline int GetKeyIndexForD()
{
    return ImGui::GetKeyIndex(ImGuiKey_D);
}
...
ed::EditorAction::AcceptResult ed::NavigateAction::Accept(const Control& control)
{
    ...
    if (ImGui::IsWindowFocused() && ImGui::IsKeyPressed((ImGuiKey)GetKeyIndexForF()) && Editor->AreShortcutsEnabled())
    {
