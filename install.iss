...
DefaultDirName={%USERPROFILE}\.ucodegameengine
DisableDirPage=yes
...
OutputBaseFilename=UCodeGameEngineSetup
Compression=lzma
...
[Files]
Source: "Output\UCodeEditor\Win64\Published\{#MyAppExeName}"; DestDir: "{app}\bin"; Flags: ignoreversion
