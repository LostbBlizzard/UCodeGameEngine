...
void Asyn_Map_Erase(TaskID id, RuningTaskDataList& val);
bool Asyn_HasOnDone(TaskID id);
bool Asyn_HasOnDone(TaskID id, RuningTaskDataList& val);

TaskProgress Asyn_GetProgress(TaskID id);
bool Asyn_RuningTasks_HasValue(TaskID id);
bool Asyn_RuningTasks_HasValue(TaskID id, RuningTaskDataList& val);
